            ...
            <div class="products-wrapper" id="goods-container">
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_1.jpg" alt="image-1" />
                </div>
                  ...
                  <div class="products-card__description-row">
                    <div class="products-card__description-controls">
                      <button class="btn btn-primary">
                        В корзину
                        <img src="../assets/images/icons/shopping-cart.svg" alt="shopping_cart" />
                      </button>
              ...
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_2.jpg" alt="image-2" />
                </div>
                <div class="products-card__description">
                  <div class="products-card__description-row">
                    <h5 class="products-card__description--name">
              ...
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_3.jpg" alt="image-3" />
                </div>
                <div class="products-card__description">
                  <div class="products-card__description-row">
                    <h5 class="products-card__description--name">
              ...
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_4.jpg" alt="image-4" />
                </div>
                <div class="products-card__description">
                  <div class="products-card__description-row">
                    <h5 class="products-card__description--name">
              ...
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_5.jpg" alt="image-5" />
                </div>
                <div class="products-card__description">
                  <div class="products-card__description-row">
                    <h5 class="products-card__description--name">
              ...
              <div class="products-card">
                <div class="products-card__image">
                  <img src="../assets/images/goods/image_6.jpg" alt="image-6" />
                </div>
                <div class="products-card__description">
                  <div class="products-card__description-row">
                    <h5 class="products-card__description--name">
